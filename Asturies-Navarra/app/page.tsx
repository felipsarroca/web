...
export default function Home(){
  ...
  useEffect(()=>{ Promise.all([fetch("/data/asturies.txt").then(r=>r.text()),fetch("/data/navarra.txt").then(r=>r.text())]).then(([a,n])=>setActivities([...parseTable(a,"Astúries"),...parseTable(n,"Navarra")])); },[]);

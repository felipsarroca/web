...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    {tab === "Resum" && <>
      ...
      <section className="how-it-works" aria-labelledby="how-title"><div><p className="eyebrow">COM FER SERVIR LA GUIA</p><h2 id="how-title">Un pla realista en tres decisions</h2></div><ol><li><b>Tria una àncora</b><span>La visita que justifica el desplaçament.</span></li><li><b>Comprova temps i reserva</b><span>Decideix amb la informació del mateix dia.</span></li><li><b>Afegeix un complement</b><span>Només si és proper i encara queda energia.</span></li></ol></section>
